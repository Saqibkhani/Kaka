...
██████╔╝██║░░██║░╚═██╔═╝░██║
╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░╚═╝
      I LOVE YOU MOM       \033[1;0m
\033[1;96m«-----------------\033[1;91mBlackMafia\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈┈  SAQIKAKA
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈┈┈  NIAZIFIGHTERGANG
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03126707840
\033[1;96m«-----------------\033[1;91mBlackMafia\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;96m[1]  OPERATE WithOut Fb        ●")
    time.sleep(0.05)
    print("\033[1;96m[2]  OPERATE WITH Facebook        ●")
    time.sleep(0.05)
    print("\033[1;96m[3]  Install SpideR       Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[4]  Install linux       Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[5]  Install BHat        Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[6]  New      Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[7]  Install Hack3r     Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[8]  Install Cobra           Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[9]  Install Dragon          Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[10] Install  QOBRA     Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[11] Install Load         Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[12] Install Hacker       Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[13] Install Compiler        Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[14] OPERATE I Brut  Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[15] Install  Base      Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[16] Install Gmail   Tool      ●")
    time.sleep(0.05)
...
def mafia():
	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/SAQIBKHANNINZAI/fighter.git ")
                print (logo)
